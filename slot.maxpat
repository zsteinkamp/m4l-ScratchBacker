...
,
		"classnamespace" : "box",
		"rect" : [ 1079.0, 194.0, 1636.0, 1512.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 959.0, 1086.0, 34.0, 22.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 522.0, 811.0, 55.0, 22.0 ],
					"text" : "pak 1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 522.0, 864.0, 30.0, 22.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1126.0, 1038.0, 81.0, 22.0 ],
					"text" : "r ---globalAmt"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 149.0, 577.0, 79.0, 22.0 ],
					"text" : "r ---globalDur"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 999.0, 949.0, 50.0, 22.0 ],
					"text" : "960."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 776.0, 541.0, 37.0, 22.0 ],
					"text" : "sel 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 523.0, 1073.0, 29.5, 22.0 ],
					"text" : "t f f"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 346.0, 893.0, 85.0, 288.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 863.0, 356.0, 101.0, 60.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_freeze_color"
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1099.0, 463.0, 101.0, 114.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_freeze_color"
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1174.0, 300.0, 98.0, 60.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_freeze_color"
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 984.0, 124.0, 262.0, 100.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_freeze_color"
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 201.0, 344.0, 261.0, 141.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_freeze_color"
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 644.0, 1107.0, 84.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_freeze_color"
						}
...
,
					"text" : "Flash the button when triggered.",
					"textcolor" : [ 0.262745098039216, 0.568627450980392, 0.901960784313726, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 156.0, 958.0, 67.0, 49.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 2.0, 55.0, 38.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 714.0, 880.0, 99.0, 22.0 ],
					"text" : "send ---dumpDur"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1221.0, 995.0, 101.0, 22.0 ],
					"text" : "send ---dumpAmt"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 714.0, 837.0, 50.0, 22.0 ],
					"text" : "500."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1221.0, 948.0, 50.0, 22.0 ],
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 959.0, 1132.0, 73.0, 22.0 ],
					"text" : "s~ ---disturb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 523.0, 1038.0, 52.0, 22.0 ],
					"text" : "gate 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 914.0, 1179.0, 184.0, 68.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 0.0, 48.0, 42.0 ],
					"saved_attribute_attributes" : 					{
						"activelinecolor" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 587.0, 760.0, 50.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_longname" : "slotDuration#1",
							"parameter_mmax" : 100000.0,
							"parameter_modmode" : 0,
							"parameter_shortname" : "SlotDuration#1",
							"parameter_type" : 0
						}

					}
,
					"varname" : "slotDuration#1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 587.0, 724.0, 53.0, 22.0 ],
					"text" : "route #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 587.0, 687.0, 127.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 723.0, 1023.0, 32.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 723.0, 1132.0, 133.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 723.0, 1098.0, 61.0, 22.0 ],
					"text" : "delay 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 736.0, 1062.0, 146.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1077.0, 888.0, 50.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 704.0, 929.0, 32.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 733.0, 962.0, 30.0, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 612.0, 979.0, 30.0, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 462.0, 803.0, 42.0, 22.0 ],
					"text" : "t b 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 462.0, 842.0, 39.0, 22.0 ],
					"text" : "click~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 462.0, 898.0, 136.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 462.0, 980.0, 56.0, 20.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 462.0, 727.0, 53.0, 22.0 ],
					"text" : "route #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 462.0, 687.0, 84.0, 22.0 ],
					"text" : "r ---slotTrigger"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1077.0, 848.0, 53.0, 22.0 ],
					"text" : "route #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1077.0, 803.0, 116.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 801.0, 949.0, 78.0, 22.0 ],
					"text" : "selector~ 2 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1004.0, 734.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 830.0, 848.0, 44.0, 22.0 ],
					"text" : "sig~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 897.0, 773.0, 95.0, 22.0 ],
					"text" : "expr ($f1 * 2) - 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1004.0, 773.0, 77.0, 22.0 ],
					"text" : "loadmess 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 959.0, 823.0, 77.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 897.0, 880.0, 142.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 897.0, 824.0, 31.0, 22.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1078.0, 982.0, 129.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1078.0, 948.0, 31.0, 22.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 959.0, 1038.0, 30.0, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 476.0, 527.0, 108.0, 22.0 ],
					"text" : "send ---dumpBang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 773.0, 735.0, 99.0, 22.0 ],
					"text" : "send ---dumpList"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 464.0, 560.0, 39.0, 22.0 ],
					"text" : "dump"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 464.0, 344.0, 62.0, 22.0 ],
					"text" : "t b b b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1112.0, 274.0, 53.0, 22.0 ],
					"text" : "route #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1112.0, 234.0, 75.0, 22.0 ],
					"text" : "r ---slotBang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1014.0, 274.0, 53.0, 22.0 ],
					"text" : "route #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1014.0, 234.0, 65.0, 22.0 ],
					"text" : "r ---slotList"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1141.0, 389.0, 42.0, 22.0 ],
					"text" : "goto 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 156.0, 1064.0, 61.0, 22.0 ],
					"text" : "s ---active"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.0, 1023.0, 30.0, 22.0 ],
					"text" : "#1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 464.0, 234.0, 59.0, 22.0 ],
					"text" : "r ---active"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 464.0, 279.0, 41.0, 22.0 ],
					"text" : "sel #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 561.0, 375.0, 131.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 487.0, 468.0, 151.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 1112.0, 319.0, 32.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1014.0, 319.0, 30.0, 22.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 975.0, 358.0, 30.0, 22.0 ],
					"text" : "$3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1025.0, 389.0, 39.0, 22.0 ],
					"text" : "$1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 1025.0, 483.0, 61.0, 22.0 ],
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 975.0, 389.0, 30.0, 22.0 ],
					"text" : "t f b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 975.0, 520.0, 47.0, 22.0 ],
					"text" : "pack f i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 975.0, 555.0, 87.0, 22.0 ],
					"text" : "setcurve $2 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1086.0, 389.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 0.0, 1.0, 0, 0.0, 0.421052631578947, 0.8, 0, 0.0, 1.0, 0.0, 0, 0.445 ],
					...
					"bgcolor" : [ 1.0, 0.67843137254902, 0.337254901960784, 1.0 ],
					"classic_curve" : 1,
					"clicksustain" : 0,
					"domain" : 1.0,
					...
					"ignoreclick" : 1,
					"legend" : 0,
					"linecolor" : [ 0.094117647058824, 0.094117647058824, 0.094117647058824, 1.0 ],
					"linethickness" : 2.0,
					"maxclass" : "function",
					"mode" : 1,
					"numinlets" : 1,
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 752.0, 675.0, 50.0, 35.0 ],
					"pointsize" : 3.0,
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 59.0, 42.0 ],
					"saved_attribute_attributes" : 					{
						"bgcolor" : 						{
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-31" : [ "slotDuration#1", "SlotDuration#1", 0 ],
